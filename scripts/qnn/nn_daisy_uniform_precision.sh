...
# This script runs Daisy's uniform precision analysis for all networks and 
...
do
  ...
  timeout 300m ./daisy --qnn --codegen --lang=C --apfixed --precision=Fixed32 ${input_file_path}/${file}.scala
