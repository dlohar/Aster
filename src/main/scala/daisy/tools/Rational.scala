...
object Rational {
  ...
  def tanhUp(x: Rational): Rational = {
    val dblValue = x.doubleValue
    val mpfrRes = java.lang.Math.nextUp(MPFRFloat.tanhUp(MPFRFloat.fromDouble(dblValue)).doubleValue)
    Rational.fromDouble(mpfrRes)
  }
  def tanhDown(x: Rational): Rational = {
    val dblValue = x.doubleValue
    val mpfrRes = java.lang.Math.nextDown(MPFRFloat.tanhDown(MPFRFloat.fromDouble(dblValue)).doubleValue)
    Rational.fromDouble(mpfrRes)
  }
